...
function ReviewCard({ category, channelName, subscriberCount, reviewCount, rating, bestReview }) {
    return (
        <div className='review-card-container'>
            <img className="yt_img" src={require('./월간윤종신.jpg').default} alt={ channelName } title = { channelName } />
